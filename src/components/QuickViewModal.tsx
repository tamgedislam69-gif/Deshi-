...
import { X, Star, ShieldCheck, Truck, Check, ShoppingBag, ArrowRight } from 'lucide-react';
          ...
          <div className="space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-400">({product.reviewsCount} কাস্টমার রিভিউ)</span>
              </div>
              ...
              <div className="p-3 bg-amber-50/60 rounded-xl border border-amber-200/60 space-y-1.5 text-xs text-amber-900">
                ...
                <div className="flex items-center gap-1.5 font-bold">
                  ...
                  <span>ক্যাশ অন ডেলিভারি - পণ্য হাতে পেয়ে টাকা দেবেন</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-slate-200 flex items-center gap-3">
              <button
                ...
                className="flex-1 bg-amber-500 hover:bg-amber-600 active:scale-95 text-slate-950 font-black py-3 px-4 rounded-2xl shadow-lg transition-all text-sm flex items-center justify-center gap-2 cursor-pointer animate-pulse-ring"
              >
